...
export const metadata: Metadata = {
  ...
  description: 'Culture isn\'t built at off-sites or by hanging values on a wall. It\'s built in the daily decisions you make as a manager. Small teams have more power to shape it than they realize.',
}
    ...
    <div style={{ background: '#F5F0E8', minHeight: '100vh' }}>
      ...
      <article style={{ maxWidth: 780, margin: '0 auto', padding: '40px 24px 80px' }}>
        ...
        <div style={{ fontFamily: 'var(--font-source-sans)', fontSize: 17, color: '#2C2C2C', lineHeight: 1.75 }}>
          ...
          <p>If you blow it, get distracted in a 1:1, handle a mistake badly, get impatient in a meeting, it matters less than you fear, provided your overall pattern is solid. Culture isn&rsquo;t set by individual moments. It&rsquo;s set by the dominant pattern over time.</p>

          <p>What I&rsquo;d caution against is using this as an excuse to not repair things. When you have a bad moment, name it: &ldquo;I was short with you in that meeting and I want to acknowledge it. That wasn&rsquo;t right.&rdquo; The repair is almost as important as the pattern. It models something: accountability doesn&rsquo;t just go one direction on this team. You hold yourself to the same standards you hold them to.</p>
