  ...
  return (
    <div style={{ background: '#F5F0E8', minHeight: '100vh' }}>
      ...
      <article style={{ maxWidth: 780, margin: '0 auto', padding: '40px 24px 80px' }}>
        <p style={{ fontFamily: 'var(--font-dm-sans)', fontWeight: 700, fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#C8782A', marginBottom: 16 }}>
          Feedback ·
        </p>
        ...
        <div style={{ fontFamily: 'var(--font-source-sans)', fontSize: 17, color: '#2C2C2C', lineHeight: 1.75 }}>
          ...
          <p>There are dozens of feedback frameworks. Most of them work. What matters isn&rsquo;t which framework you use. It&rsquo;s that you use something that forces you to be specific and ends with a clear ask. Here&rsquo;s the version I&rsquo;ve used and taught the most:</p>

          <ol style={{ paddingLeft: 24, margin: '24px 0' }}>
            <li style={{ marginBottom: 20 }}>
              <strong>Observation: what you saw, specifically.</strong> Not an interpretation, not a judgment. Just what happened. &ldquo;In the client call on Wednesday, you cut Alex off twice before they finished their point.&rdquo; Not &ldquo;you were dismissive&rdquo;, which is an interpretation. The specific behavior, in a specific context. This matters because it&rsquo;s harder to argue with and easier to understand. &ldquo;You were dismissive&rdquo; is debatable. &ldquo;You cut them off twice&rdquo; is a fact.
            </li>
            <li style={{ marginBottom: 20 }}>
              <strong>Impact: what it did.</strong> This is the part that makes feedback land differently. Not &ldquo;that wasn&rsquo;t great.&rdquo; Try: &ldquo;Alex stopped contributing for the rest of the meeting, and I noticed the client started directing their questions away from them.&rdquo; When people understand the actual impact of their behavior, not a judgment but an actual effect on the world, the feedback lands differently. Most people don&rsquo;t intend to have the impact they have. Naming it creates the opening for change.
            </li>
            <li style={{ marginBottom: 20 }}>
          ...
          <p>I ask my direct reports for feedback in 1:1s every month or so: &ldquo;What&rsquo;s one thing I could do differently as your manager that would make your work easier or better?&rdquo; When they answer, and they will if they trust you, I listen without explaining or defending. I say thank you. I write it down. And I follow up on it the next week: &ldquo;I&rsquo;ve been thinking about what you said last week, and here&rsquo;s what I&rsquo;m going to do differently.&rdquo;</p>
        ...
        <ShareBar title="How to Give Feedback Your Team Will Actually Hear" url="https://cadencehq.co/blog/how-to-give-feedback-your-team-will-hear" />
        <div style={{ marginTop: 64, padding: 24, background: 'white', border: '1px solid #D0CAC0', borderRadius: 8, display: 'flex', gap: 16, alignItems: 'flex-start' }}>
          <img src="https://whzwyvjerrsyqjmktxcg.supabase.co/storage/v1/object/public/avatars/06d4938c-f40d-46dd-b24c-3a2596e0c8a1/avatar.jpg?t=1773037991750" alt="Sean Davis" style={{ width: 56, height: 56, borderRadius: '50%', objectFit: 'cover', border: '2px solid #D0CAC0', flexShrink: 0 }} />
          <div>
