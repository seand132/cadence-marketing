    ...
    <div style={{ background: '#F5F0E8', minHeight: '100vh' }}>
      ...
      <article style={{ maxWidth: 780, margin: '0 auto', padding: '40px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 40 }}>
          {[
            { label: 'Share on X', href: 'https://twitter.com/intent/tweet?text=How%20to%20Delegate%20Without%20Losing%20Control&url=https://cadencehq.co/blog/how-to-delegate-without-losing-control' },
            { label: 'Share on LinkedIn', href: 'https://linkedin.com/sharing/share-offsite/?url=https://cadencehq.co/blog/how-to-delegate-without-losing-control' },
          ].map((btn) => (
