  ...
  return (
    <div style={{ background: '#F5F0E8', minHeight: '100vh' }}>
      ...
      <article style={{ maxWidth: 780, margin: '0 auto', padding: '40px 24px 80px' }}>
        <p style={{ fontFamily: 'var(--font-dm-sans)', fontWeight: 700, fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#7A9E82', marginBottom: 16 }}>
          One-on-Ones ·
        </p>
        ...
        <div style={{ fontFamily: 'var(--font-source-sans)', fontSize: 17, color: '#2C2C2C', lineHeight: 1.75 }}>
          ...
          <div style={{ background: '#FDF6EE', border: '1px solid #EBD5B8', borderTop: '3px solid #C8782A', borderRadius: 6, padding: '20px 24px', margin: '32px 0' }}>
            ...
            <p style={{ fontFamily: 'var(--font-source-sans)', fontSize: 16, color: '#2C2C2C', lineHeight: 1.6, margin: 0 }}>At the start of your next 1:1, ask each person: &ldquo;What do you actually want to get out of our 1:1s? What would make them more useful for you?&rdquo; You might be surprised how many people have never been asked. Some have had a clear answer for months.</p>
          </div>
          ...
          <p>I built Cadence partly because I kept losing this. My 1:1 notes were scattered across five different places, I had no easy way to see patterns across conversations, and prep before each meeting took longer than it should. I wanted a system where the rhythm was easy enough to sustain without thinking about it. If you&rsquo;re managing a team right now, start there: pick a system, any system, and commit to it for 90 days. See what changes.</p>

        </div>

        <ShareBar title="The 1:1 That Actually Works" url="https://cadencehq.co/blog/the-11-that-actually-works" />
